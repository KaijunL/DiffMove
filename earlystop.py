...
class EarlyStopping:
    ...
    def __call__(self, score, model):
        ...
        if self.best_score is None:
            ...
            self.counter += 1
          #  print(f'EarlyStopping counter: {self.counter} out of {self.patience}')  #original 18 Nov 2023
            print(f'EarlyStopping counter: {self.counter} out of {self.patience}, so far best score is {self.best_score}')  #modified 18 Nov 2023
